...
return new class extends Migration
{
    ...
    {
        Schema::create('p_district', function (Blueprint $table) {
            $table->id();
            $table->string('admin2Name_en')->nullable();
            $table->string('admin2Name_si')->nullable();
            $table->string('admin2Name_ta')->nullable();
            $table->string('admin2Pcode')->nullable();
            ...
            $table->integer('P_median')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('p_district');
    }
};
