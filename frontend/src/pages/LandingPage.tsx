...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 10, textAlign: 'center', display: 'flex', flexDirection: 'column', height: '100vh', pt: 8, pb: 4 }}>
        
        {/* Top Titles Section */}
        <Box sx={{ mt: 2, mb: 8, textShadow: '2px 2px 4px rgba(0,0,0,0.9)' }}>
          <Box sx={{ display: 'flex', justifyContent: 'center', mb: 3 }}>
            <img src={logoImg} alt="Ceylonica Logo" style={{ height: '120px', width: 'auto', filter: 'drop-shadow(0px 4px 10px rgba(0,0,0,0.5))' }} />
          </Box>
          <Typography
            variant="h1"
            sx={{
        ...
        {/* Action Buttons */}
        <Box sx={{ mb: 'auto', display: 'flex', flexDirection: 'column', gap: 2.5, alignItems: 'center' }}>
          <Button
            variant="contained"
            size="large"
            endIcon={<ExploreIcon />}
          ...
          >
            Your Own Village Community Information Platform / ඔබේම ගමේ ප්‍රජා තොරතුරු වේදිකාව
          </Button>
      ...
      >
        <Typography variant="h3" sx={{ color: '#FBBF24', mb: 4, fontWeight: 700, fontFamily: '"Iskoola Pota", "Abhaya Libre", sans-serif', maxWidth: '1200px', lineHeight: 1.4 }}>
          මේ ඔබ පිවිසෙන්නේ ලංකා සංවර්ධන හා තොරතුරු සාමූහිකය මඟින් පහසුකම් සලසන ඔබේම ගමේ ප්‍රජා තොරතුරු වේදිකාවටය.
        </Typography>
        <Typography variant="h4" sx={{ color: 'white', mb: 4, fontWeight: 500, maxWidth: '1200px', lineHeight: 1.4 }}>
        ...
        <Typography variant="h4" sx={{ color: '#94a3b8', fontWeight: 500, maxWidth: '1200px', lineHeight: 1.4 }}>
